# Generated by Django 4.2.4 on 2023-08-15 19:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_pedido', models.CharField(blank=True, max_length=200, null=True, verbose_name='Nº Pedido')),
                ...
                ('pedido_pago', models.BooleanField(blank=True, default=False, null=True, verbose_name='Pedido Pago')),
                ('motoboy_pago', models.BooleanField(blank=True, default=False, null=True, verbose_name='Motoboy Pago')),
                ('descricao', models.TextField(blank=True, null=True, verbose_name='Informações adicionais')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(blank=True, max_length=20, null=True, verbose_name='UF')),
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_CotacaoEntregas.cliente')),
            ],
            options={
